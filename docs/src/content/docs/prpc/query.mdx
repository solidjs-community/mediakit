...
`query$` is a factory for constructing [createQuery](https://tanstack.com/query/latest/docs/framework/solid/reference/createQuery) functions. It should be used whenever createQuery should be used.
