...
The `signIn` function is a function that will be used from the client side to sign in the user, after signing in, the session in [`useAuth`](/auth/useauth) will be refetched and updated accordingly.
